  ...
  return (
    <SafeAreaView style={styles.carouselWrapper}>
      <View style={styles.carouselView}>
        <Carousel containerCustomStyle={styles.carouselContainer} onSnapToItem={i => setActiveHero(heroList[i])} data={heroList} renderItem={_renderItem} sliderWidth={SLIDER_WIDTH} itemWidth={250} />
      </View>
    </SafeAreaView>
  );
}

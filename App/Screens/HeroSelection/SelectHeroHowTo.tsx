...
import {  FlatList, SectionList, ScrollView,  Box, Center, View, Text, Heading, VStack, FormControl, Input, Link, Button, Icon, IconButton, HStack, Divider } from 'native-base';
...
const SelectHeroHowTo = ({ navigation }) =>{
  ...
  const navigateToSelectHero = () =>{
    console.log('THE LIST', heroList);
    navigation.push("SelectHero", { heroList });
  ...
  return (
    <ScreenContainer>
      <ScrollView>
        ...
        <Button onPress={() => navigateToSelectHero()}>OK</Button>
      </ScrollView>
    </ScreenContainer>
  )
}

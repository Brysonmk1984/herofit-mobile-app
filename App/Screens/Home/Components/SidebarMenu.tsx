...
const SidebarMenu: React.FC<SidebarMenuProps> = ({ navigation, setSideDrawerOpen, heroName }) => {
  ...
  return (
    <VStack bgColor="base.primary" height="100%" justifyContent="space-between" borderLeftWidth="1" borderLeftColor="base.brand" pb={5}>
      <VStack space={1} pt={5}>
        <Button variant="ghost" borderColor="#40403e" borderTopWidth="1" borderBottomWidth="1" pl={3} mt={5} onPress={() => handleNavigation(() => WebBrowser.openBrowserAsync(`https://herofitgame.com/#donate`))} fontSize="2xl" fontFamily="heading" _text={{ color: "primary.200" }} _pressed={{ _text: { color: "base.brand" }, bgColor: "base.primary" }}>
          <Text color="base.highlight" fontSize="2xl" fontFamily="bebas-neue">
            Donate
          </Text>
        </Button>
        <Button variant="ghost" borderColor="#40403e" borderBottomWidth="1" pl={3} onPress={() => handleNavigation(() => navigation.push("Adversaries"))} fontSize="2xl" fontFamily="heading" _text={{ color: "primary.200" }} _pressed={{ _text: { color: "base.brand" }, bgColor: "base.primary" }}>
          Adversaries
        </Button>

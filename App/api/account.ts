...
const updateAvatarName = async function(body){
  return axios.post(`${endpoint}account/update-avatar-name`, body, await axiosOptions())
  .then(({ data }) => {
    return data.data;
...
const updateOwnerUsername = async function(body){
  return axios.post(`${endpoint}account/update-owner-username`, body, await axiosOptions())
  .then(({ data }) => {
    return data;
  }).catch(({ request, response }) => {
    throw handleHttpError(request, response);
...
const disconnectStrava = async function(body){
  return axios.post(`${endpoint}auth/disconnect-strava`, body, await axiosOptions())
  .then(({ data }) =>{
    return data;
  }).catch(({ request, response }) => {
    throw handleHttpError(request, response);

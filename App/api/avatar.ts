...
const insertAvatar = async function (body) {
  return axios
    .post(`${endpoint}avatar/insert-avatar`, body, await axiosOptions())
    .then(({ data }) => {
      return data.data;
    })
...
const updateAvatarStats = async function (body) {
  return axios
    .post(`${endpoint}avatar/update-avatar-stats`, body, await axiosOptions())
    .then(({ data }) => {
...
const checkAvatarName = async function (body) {
  return axios
    .post(`${endpoint}avatar/check-avatar-name`, body, await axiosOptions())
    .then(({ data }) => {
      return data.data;
    })
    .catch(({ request, response }) => {
...
const fetchAvatarsByPage = async function (body) {
  return axios
    .post(`${endpoint}avatar/fetch-avatars-by-page`, body, await axiosOptions())
    .then(({ data }) => {
      return data.data;
    })
    .catch(({ request, response }) => {
...
const fetchAvatarsByPageAndRankingType = async function (body) {
  return axios
    .post(`${endpoint}avatar/fetch-avatars-by-page-and-ranking-type`, body, await axiosOptions())
    .then(({ data }) => {
      return data.data;
    })
    .catch(({ request, response }) => {
...
const fetchAvatarsByPageAndRankingTypeBattle = async function (body) {
  return axios
    .post(`${endpoint}avatar/fetch-avatars-by-page-and-ranking-type-battle`, body, await axiosOptions())
    .then(({ data }) => {
      return data.data;
    })
    .catch(({ request, response }) => {

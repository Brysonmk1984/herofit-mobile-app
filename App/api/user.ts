...
const getSavedActivities = async function(body){
  return axios.post(`${endpoint}user/get-user-activities`, { ...body }, await axiosOptions())
  .then(({ data }) =>{
...
const instantiateUserTotals = async function(body){
  return axios.post(`${endpoint}user/instantiate-user-totals`, body, await axiosOptions())
  .then(({ data }) => {
      return data.data;
  }).catch(({ request, response }) => {
    throw handleHttpError(request, response);
...
const updateUserTotals = async function(body){
  return axios.post(`${endpoint}user/update-user-totals`, body, await axiosOptions())
  .then(({ data }) => {
      return data.data;
  }).catch(({ request, response }) => {
    throw handleHttpError(request, response);
...
const getProfileInfoByHeroName = async function(body){
  return axios.post(`${endpoint}user/get-profile-info-by-email`, body, await axiosOptions())
  .then(({ data }) => {
      return data.data;
  }).catch(({ request, response }) => {
    throw handleHttpError(request, response);
...
const getMatchingUsers = async function(body){
  return axios.post(`${endpoint}user/get-matching-users`, body, await axiosOptions())
  .then(({ data }) => {
      return data.data;
  }).catch(({ request, response }) => {
    throw handleHttpError(request, response);
...
const getHeroNameByUsername = async function(body){
  return axios.post(`${endpoint}user/get-hero-name-by-username`, body, await axiosOptions())
  .then(({ data }) => {
      return data.data;
  }).catch(({ request, response }) => {
      throw handleHttpError(request, response);

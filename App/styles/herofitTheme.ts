export default {
  ...
  colors: {
    ...
    base: { primary: "#2b2b2a", primaryAlt: "#383837", secondary: "#333633", background: "#E7EDDF", white: "#ffffff", black: "#000000", textShadowColor: "rgba(36, 36, 35, 0.75)", info: "#16a0f5", error: "#BF0000", caution: "#ff6700", success: "#356735", disabled: "#555554", disabledText: "#6c6c6b", highlight: "#f1c85b", highlightTransparent: "rgba(255,255,240, .6)", lowlight: "#1d0e29", brand: "#d4af37", strava: "#FC4C02", fire: "#e25822", earth: "#8A360F", water: "#0f5e9c", air: "#16a0f5", aether: "#FFFFC2", all: "#e1e1e0", workout: "#a0a09f", other: "#a0a09f", link: "#3792cb", health: "#A30216", armor: "#242130", power: "#303030", recovery: "#356735", timber_terror: "#3D2A18", repete: "#9B9B9B", filtron_five: "#EBEBEB", chrono_guy: "#4B4B4B", solar_celeste: "#EBDD49", wilhelm_the_wild: "#533B27", natural_ninja: "#0C2613", empath_aurelia: "#7D0110", boulder_bro: "#986634", compost_creature: "#796D20", consumable: "#b91c1c", pet: "#40E0D0", skin: "#7e22ce", title: "#f97316", codex: "#9d174d", transparent: "rgba(255,255,255,0)", lightTransparent: "rgba(255,255,255,.5)", darkTransparent: "rgba(0,0,0,.6)", qp: "#C889FF", pt: "#DECC24" },
